    ...
    try {
        ...
        app.get('/api/farmer/products/pegination', async (req, res) => {
            try {
                ...
                if (req.query.farmerEmail) {
                    query.farmerEmail = req.query.farmerEmail;
                }
        ...
        app.post('/api/ai/generate-product', async (req, res) => {
            ...
            const buildFallback = (name) => {
                ...
                const shortDescription = `Fresh ${displayName} sourced directly from Bangladeshi farms, ensuring maximum freshness and quality. ` +
            ...
            try {
                ...
                const chatCompletion = await openai.chat.completions.create({
                    ...
                    messages: [
                        {
                            role: 'system',
                            content: 'You are an expert agricultural product listing assistant for a Bangladeshi e-commerce marketplace. ' +
        ...
        app.post('/api/ai/doctor-chat', async (req, res) => {
            const { role: bodyRole, message } = req.body;
...
`.trim();
        ...
        app.post('/api/store-payment', async (req, res) => {
            try {
                ...
                await productsCollaction.updateOne({ _id: new ObjectId(productId) }, {
                    $set: {
